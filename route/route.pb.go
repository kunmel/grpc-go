...
const (
	RecommendationMode_GetFarthest RecommendationMode = 0 //enum从0开始
...
type Point struct {
	...
	Latitude  int32 `protobuf:"varint,1,opt,name=latitude,proto3" json:"latitude,omitempty"` //此处的=右侧的数字代表键值对的key，能够压缩长度，节约流量，要从1开
...
var file_route_proto_rawDesc = []byte{
	...
	0x63, 0x6f, 0x6d, 0x2f, 0x48, 0x61, 0x6e, 0x46, 0x61, 0x2f, 0x6c, 0x65, 0x61, 0x72, 0x6e, 0x2d,
	0x67, 0x6f, 0x2f, 0x67, 0x72, 0x70, 0x63, 0x2d, 0x65, 0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x2f,
